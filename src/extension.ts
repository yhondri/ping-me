...
export function activate(context: vscode.ExtensionContext) {
	...
	const onDidChangeWindowStateDisposable = vscode.window.onDidChangeWindowState((windowState) => {
	...
	const notifyCommandDisposable = vscode.commands.registerCommand('ping-me.notify', () => {
		notifyCompletion();
	});
